/*1676414262,,JIT Construction: v1006958085,vi_VN*/
...
try {
        ...
        for (var i = 0; i < sandboxSafelist.length; i++) {
            ...
            with(this) {
                ...
                __d("sdk.SharedStringConstants", ["sdk.fbt"], (function(a, b, c, d, e, f, g) {
                    "use strict";
                    a = {
                        continueWith: c("sdk.fbt")._("Ti\u1ebfp t\u1ee5c v\u1edbi {facebook_app_name} ho\u1eb7c {instagram_app_name}"),
                        continueWithShort: c("sdk.fbt")._("{facebook_app_name} ho\u1eb7c {instagram_app_name}"),
                        loginButtonAriaLabel: c("sdk.fbt")._("Ti\u1ebfp t\u1ee5c b\u1eb1ng Facebook ho\u1eb7c Instagram"),
                        logout: c("sdk.fbt")._("\u0110\u0103ng xu\u1ea5t"),
                        logoutButtonAriaLabel: c("sdk.fbt")._("\u0110\u0103ng xu\u1ea5t kh\u1ecfi trang web hi\u1ec7n t\u1ea1i"),
                        titleText: c("sdk.fbt")._("Ch\u1ecdn t\u00e0i kho\u1ea3n"),
                        promptText: c("sdk.fbt")._("B\u1ea1n mu\u1ed1n d\u00f9ng t\u00e0i kho\u1ea3n n\u00e0o \u0111\u1ec3 \u0111\u0103ng nh\u1eadp?"),
                        facebookText: c("sdk.fbt")._("\u0110\u0103ng nh\u1eadp b\u1eb1ng Facebook"),
                        facebookTextShort: c("sdk.fbt")._("Log in"),
                        instagramText: c("sdk.fbt")._("\u0110\u0103ng nh\u1eadp b\u1eb1ng Instagram"),
                        disambiguationDialogAriaLabelText: c("sdk.fbt")._("Log in with Facebook or Instagram"),
                        fbButtonText: c("sdk.fbt")._("Ti\u1ebfp t\u1ee5c v\u1edbi Facebook"),
                        igButtonText: c("sdk.fbt")._("Ti\u1ebfp t\u1ee5c b\u1eb1ng Instagram")
                    };
    ...
    i.src = 'https://www.facebook.com/platform/scribe_endpoint.php/?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script || "sdk.js") + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"1006958085","namespace":"FB","message":"' + e.message + '"}}');
